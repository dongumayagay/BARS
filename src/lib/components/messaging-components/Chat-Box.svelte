...
<form on:submit|preventDefault={dispatchHandler} class="w-full h-max flex flex-col lg:flex-row items-center gap-4">
    ...
    <div class="w-full flex gap-3">
        <input title="Send a message" placeholder="Send a message" class="input input-sm w-full dark:input-primary" bind:value={content} disabled={status==="Request Completed" || status==="Appointment Served"} required>
