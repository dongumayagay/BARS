...
export async function notifyExpiredRequest(request, lastUpdatedString){
    const result = await sendEmail({
        ...
        <p>Your requested document/s has been unclaimed for exactly or more than 7 days since this request's last update: [ ${lastUpdatedString} ]. We will now close this request.</p>
