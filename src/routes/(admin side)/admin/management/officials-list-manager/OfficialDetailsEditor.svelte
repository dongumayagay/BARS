...
<section class="absolute top-0 left-0 w-full h-full flex items-center justify-center bg-black/40">
    <form class="w-[70%] min-h-[70%] h-max bg-neutral p-6 rounded-xl shadow-xl relative" on:submit|preventDefault={submitHandler}>
        <div class="w-full flex justify-between p-2">
            ...
            <button type="button" class="w-max btn btn-error btn-sm gap-2" disabled={isAdd} on:click={deleteHandler}>
            ...
            <div class="w-full flex justify-center py-1">
                ...
                <div class="w-full flex flex-col items-center">
                    ...
                    <div class="w-full flex justify-center items-center gap-2">
                        ...
                        <input type="email" placeholder="example@provider.com" class="w-[50%] text-center input input-ghost focus:bg-transparent" required bind:value={officialDetails.email}>
